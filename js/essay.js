const essayObj = {
	...
	"6" : {
		...
		"en" : {
			...
			"In the 5th century BC, Plato claimed that the idea is the truth, while the material particular is a first level of imitation and the art is the semblance of that imitation, which is a copy of the copy (two stages of removal from the truth).<span class='footnote' data-footnote='5'></span>", 
