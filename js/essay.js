const essayObj = {
	...
	"2" : {
		...
		"en" : {
			...
			"text" : ["Paying the world’s highest average house price of 2020, the cost of a home in Hong Kong would allow you to acquire 1.6 equivalent houses in Singapore, if not almost 3 similar-sized houses in the New York City or the Parisian communes.footnotehere1 A golden fable to investors, however, it is disconnected with general Hongkongers; many simply cannot afford to own an apartment. In 2016, more than two hundred thousand residents, stretched their daily lives in subdivided units.footnotehere2 These housing types are unique to Hong Kong which has a median per capita floor area tipping a merely 5.8 square meters.footnotehere3 When many locals are failing to keep up with the simply unfeasible price of owning a home, for years a top priority of the Hong Kong Government is to resolve this crisis - increase the supply of land, build more affordable housing. ", "With an obvious shortage of land on one side, however, the geographic footprint of the city's data also craves expansion. Although rarely publicised, Hong Kong is now home to more than 50 data centres, as if its hyper-modernised landscape notated by incessant streams of glossy skyscrapers is insufficient to feed an air of sci-fi enigma.footnotehere4 Such an accumulation of data centres remains curious, when the region simply cannot find enough land to house its residents. ", "Based in Hong Kong during 2019 and 2020, we mapped and documented the emergence of data centres in the region. Our research revealed that despite persistent debates of land shortage, a post-human architectural network has emerged in plain sight, straddling two poles of the exclusivity of Hong Kong’s skyline and its wretched income disparity.", "Hong Kong’s data centres, perceived as state-of-the art technology, are yet unassuming and largely indistinguishable from the city’s generic fabric. In response to limitations of space, the Hong Kong SAR Government has deployed various pro-data tactics, such as offering waiver schemes which motivate the establishment of data centres within industrial buildings, leveraging greenfield sites besides dense streetscapes, or eschewing previously zoning for data centre construction.footnotehere5 Considered a global hotspot for this relatively new architectural typology, the Hong Kong data centre business is forecast to achieve an annual growth of 15% over the next few years.footnotehere6", "Yet, this growth estimate is bound to be challenged by a continuous geopolitical play. The region’s new national security law has allowed officials to request user data deemed to endanger national security without court orders. Related concerns for data privacy and the free flow of information could potentially undermine Hong Kong’s continued development of data centres. Within a month of the new law’s implementation, we have already witnessed South Korea’s largest internal portal, Naver, relocating to Singapore.footnotehere7", "While humans’ physical presence is increasingly deflated and transmitted at light speed to a virtual territory, does such a phenomenon justify the proliferation of data engulfing spaces of bodily occupation? Particularly in the intricate context of Hong Kong, considering its steep land shortage, satirical housing adversity, flooding capitalist embourgeoisement and a boiling political upheaval, local communities have been striving to embrace, tolerate or reject the prevalence of new ideological and spatial forms. As a new decade is unveiled, the competition has congealed into a tie, a historical impasse. In the whirligig of time, the interplay among political, economic, technological and social stakes seemingly follows no alternates but entwines deeper."],
		},

		"cn" : {

			"title" : "數據中心進佔城市樞紐",
			"text" : ["<span>在香港這個2020年全球最•高平均樓價的地方，同一筆房•屋成本可讓你在獅城購入1.6套同等的房子；在紐約大都會或巴黎花城甚至可買起接近3套•接近相同大•小的房子。這個投•資者的金色神話，一般香港人卻沒甚共鳴──絕大多數市民實無能力成為業主。2016年，超過20萬港人屈居•於港式獨有的分間樓•宇單位(俗稱劏房•)，其住戶人均居住面積僅佔•5.8平方米。當普羅大眾未能負擔在港置業的天價時，港府多年來的施政重點都是解決住屋問•題，包括增加土地供應，提供更多可負擔的房屋。</span>", "<span>雖然土地短缺可謂眾所周知，但於這城市渴求擴張空間的還有數據。不說不知，香港現時•已有最少50間數據中心，彷彿其連綿不絕的摩天•大樓所構成的超現代化景觀還是不夠科•幻。當此城明顯仍未找到足•夠的土地以解決房屋問題時•，數據中心逆天增長的現象難免令人好奇。</span>", "<span>我們於2019至2020年期間•駐居香港，繪錄了該地數據中心擴展的現象。我們的研究發現，撇除土地短缺上的爭議不斷，一個後•人類的建築網絡，正在香港獨樹一幟的天際線和水深火熱的貧富懸殊中默默延伸。</span>", "<span>數據中心此類高端建•築，在香港卻是其貌不揚地融入一•般城市景觀中。鑒於空間有限，香港特區政府須於政策上出奇制勝，如推出豁免費用計劃•，鼓勵改建現•有工業大廈作數據中心用•途、利用密集街道旁的空地、以及允許發展商不論有關•地段的規劃用途，透過修訂地•契發展數據中心等。香•港隨即成為全球數據中心炙手可熱的選址據點，未來市場需求更一度被看好，按年預測增15%。</span>", "<span>只是隨著•該地區的地緣政•治持續動盪，數據中心的增長勢必受到考驗。新通過的國家安•全法賦予官員在沒有法院命令的情況下，可要求獲取懷疑•危及國家安全的用戶數據。市場難•免醞釀•對數據•私隱度和資訊自由流動的擔憂，有機•會影響香港數•據中心的發展。新法例落實了短短一個月，韓國網絡服務巨頭Naver集團已把原設•在香港的•伺服器搬至新加坡。</span>", "<span>當人們的現實生活越發上載並來回光速傳輸於虛擬網絡中，此現象是否便能作為數據日益佔據用地的理據？尤其在香港錯•綜複雜的形勢下，考•慮到其嚴峻的•土地問題、望而生畏•的樓價、中產資本主義的橫•行以及沸騰的政治局勢，當地社•群對•新興的意識•形態和空間原形是接受、容忍•還是拒絕？當新一個十年開展之際，這些競爭亦陷入膠著的狀•態，成為歷史難題。隨著時間流逝，政治、經濟、•科技和社群的角力愈•漸加深，苦無出路。</span>"],
	...
	"6" : {
		...
		"en" : {
			...
			"text" : ["‘If Victor Hugo is going to deliver a Ted talk today,’ spatial theorist Keller Easterling suggested in her book ‘The Action is the Form’, ‘he will present the architectural model with “a thousand heads and a thousand arms” on the stage to support his theory of space in contemporary politics. Hugo, who is far from an exception among the Ted talks’ speakers, will attempt to convince you with his body mic and a pair of loafers that today, “space is the secret weapon of the most powerful people on earth.”’footnotehere1", 
			"Easterling is no stranger to the grand data centre ploy, the societal modality of the 21st century that transcends economies of physicality into a realm of virtual and artificial intelligence. In the age of information, she claimed that the discourse of architecture has shifted its focus from singular buildings to infrastructural technologies. Networks upon which our contemporary lifestyles depend, cell phone microwaves, global sea freight, the internet, all of which manifest upon a groundwork of composite infrastructural ecologies.", 
			"The evolving forms of data centres affirms that infrastructural architecture is undergoing rapid transformations. The capitalist premise of economic optimisation has informed a swarm of new architectural prototypes, orchestrating residential, recreational, cultural, corporate and governmental programmes through compositional strategies of complementation, aggregation, multiplication and reduction; new spatial products have expanded our urban landscape like never before. To Easterling, this is the ‘disposition’ of eclectic urban spectacles which have unleashed a performativity of architecture.footnotehere3", 
			"The convolution of physical and digital social patterns coupled with an explosion of new ideologies echoes contemporary spirits of multiplicity. However, such notions remain uncoupled to those of authenticity, in fact fundamentally paradoxical, their mariage blanc steering us to a ‘post-truth’ age. The intricacies of media and imagery surplus incessantly contest our definition of ‘trust’, with these ever-evolving environments rendering the increasing theatricality of contemporary life. So the question now becomes, what then defines a compelling performance?", 
			"The arts barely impress Plato, and drama even less so, largely due to their artificiality against natural being. The artist and professor of Theatre, Dance & Media at Harvard University, David Levine, elaborated on the dilemma of drama in a Frieze interview, ‘for performance to have any political value, I have to feel like this might be actually happening’.footnotehere4 So performativity needs to move beyond entertainment value, and to Levine this occurs through the act of improvisation, when actors stay in character when slipping away from predetermined narrations. To practise improvisation through the dismantling of any choreographies, numerous performance artists choose rather to infiltrate daily routine. In the same vein, what artistic medium is more prominent than architecture in its potential intervention in our everyday lives?", 
			"<div id='intermission'>Intermission</div>", 
			"If we juxtapose Easterling’s and Levine’s theories side-by-side, does it imply that Architecture is the most powerful form of performance, a medium truly embedded in reality? And if that’s the case, within this slippery fabric of  which is closest to the truth, how should humans act/react?", 
			"In the 5th century BC, Plato claimed that the idea is the truth, while the material particular is a first level of imitation and the art is the semblance of that imitation, which is a copy of the copy (two stages of removal from the truth).footnotehere5", 
			"In 2020 and beyond, we witness the contemporary world evolving into an algorithm-mediated lifestyle, when digital presence can come before physicality, when all sorts of relationship, professional, emotional, classist, etc, are to different extents determined by one’s appearance in the digital realm. Actualising the virtual, virtualising the actual... today we see the differentiation of Plato’s notions of  ‘truth’, ‘form’ and ‘copy’ becoming unprecedentedly slippery.", 
			"Then, what if Plato has an Instagram account? He may share his new theory in an Instagram story: THE IMAGE USURPS THE TRUTH. In fact, to him the immateriality of an image does carry a sweet sense of nostalgia, reminding him of the same lightness of ‘a concept’ he preciously cherished two-thousand years ago. He may carefully place a #nofilter hashtag (of course Plato despises filters). Back to his profile, the 3x3 grid is the infrastructure, whose fluid performativity is determined by the different sizes of liquid-crystal screens available on the global market today. And his posts? Perhaps some spectacular architectural shots and wait, a rather unassumingly shot of urban weeds…"],
		},

		"cn" : {

			"title" : "柏拉圖的後人類空間項目",
			"text" : ["<span>「若然今天•雨果要給一•場Ted演•講，」美國耶魯大學建築系教授Keller Easterling在著作 《行•為便是形式》(The Action is the Form)中•說到 ，「他會把屬於二十世•紀的哥德式復古主•義的宏大堂皇建築模型帶到•臺上，以闡釋空間•在當•代政治的角色。雨果本人，像無•數Ted演講的•主持人般，將會帶•上隨身的麥克•風，穿上一雙樂福•鞋，親自說服你──『空間便是最高權力的秘密武器。』」</span>", 
			"<span>Easterling對數據中心的戲法該毫不陌生。當二十一世紀的社會形態穿越實體經濟而延伸至電子資•訊和人工智慧的虛擬國度，她指出建築學亦從•單一實體建•築設計延•伸至基建科技的•發展。當代•生活依賴•的各種網絡，包括手機微波、國•際海運和互聯網等，均需強大的基建支援。</span>", "<span>從數據中心不斷的•演變中可看出，基礎建築正蓬勃轉型。強調標準化以達至最低•成本的資本主義模式促使全新建築原型的湧現，透過相輔相•成、相加相•減等手法，把住•宅•、休憩、文化、商•業、政府等用地重新譜寫。這些前所未有的•空間產物為我們建構•新的城市景觀。對於Easterling而言，•正正是此等不拘一格的城市奇觀，釋放出建築的表演性(performativity)。</span>", "<span>實虛•相交的社交模式、百花齊放的意識形態，都在呼•應著當代社會精神的多樣性(multiplicity)，卻與真實性(authenticity)有著本質上的衝突，引發出後真相現象(post-truth)。 眼花繚亂的媒體資訊、虛實失度•的泛濫影像•，讓我們對於「信任」的定義一再改寫。變幻不定的環境讓當代生活變得更富戲劇•性，然而怎樣才能成就一場出色的表演呢？ </span>", 
			"<span>戲劇對於柏拉圖而言是藝術萬惡之首，因他認為「演出」此行為本來就是有違真性情。而美國哈佛•大學劇劇、舞蹈及媒體系•教授和藝術家David Levine在2013年的專訪•中則提到，要•在表演中引伸出社會意義，必須要讓觀眾感到• 「有些事情可能真的在發生」，則•表演•亦不再被其娛樂性所局限。Levine認為•即興演出有助達至以上境界，當中演員即使脫離了劇本的故事•線，也能繼續融入•角色中。 •故此，不少行為藝術家均把他們的演•出滲進•日常生活，以拆下華麗的舞臺，練習「即興」。只是說到對日常生活的直接影響，又有什麼媒介比得起建築？</span>", 
			"<div id='intermission'>•中場休息</div>",
			"<span>若然我們把Easterling和Levine的理論相提並論，是否暗示著建築是最強大的表演形式，一種能真正介入現實的媒介？若然屬實，考慮到難以定斷的•真相本質，在城市建築的生存彷如在真相的邊緣遊走，人們又該如何自處？</span>", "<span>公元前五世紀，柏拉圖在其著作《理想國》(Republic) 中提出這世界存在•不變的真相•，亦即是我們所•認知的「理念」(ideas)。 理念是無形的，而由理•念所延伸出來，在世界中我們能觸碰的物質存在 (m•aterials)，便是對真相的•第一•層模仿。由於藝術品都是取自物質的靈感，所以是進一步的遠離真相，則複製品的複製品 (copy of the copy)。</span>", "<span>2020年及以•後，我們目睹大數據與電•子演算(algorithm)進一步支配當代人的•生活方式•。我們的真實生活甚至可取•決於虛擬•世界的經歷，人與人之間的不同•關係──無論是•專業上•、情感上、•階層間──在不同程度下都•受到網上•互動的影響。網絡一再實體化、•真實經歷卻又越•趨虛幻⋯•⋯ 柏拉•圖對「真相」、「形式」和「仿製」的•概念分析受到空•前挑戰。 </span>", "<span>那麼我們大膽設想：要是柏拉圖擁有一個Instagram•賬戶？ 他也許會在即時動態發布最新理論：圖像篡奪真相。有趣的是，柏拉圖並沒有對本世紀盛行的電子•影像有著任何反感，其非物質性甚至喚起了一種甜蜜的懷舊•氣息，•讓他回憶起二千•年前他所珍•視的「真相」的•虛無感。他會在上載的照片•放一個#零修圖的標籤（當然柏拉圖鄙視濾鏡）。在他的首頁，那3x•3的頁面設定就•如一種基礎•建設，隨著•全球不同型號的手機液晶螢幕尺寸而變得千形萬狀，形成一場場極具流動性的表演•，而他的發•文估計都是壯觀的建築特寫。咦？怎麼忽然冒出了一張平平無奇的城市野草照⋯⋯</span><span>"],
...
"Data Center Map. ‘Colocation Hong Kong - Data Centers’. Accessed 3 May 2021. <a class='biblink' href='https://www.datacentermap.com/hong-kong/hong-kong/'>></a>",
"Derrida, Jacques. ‘Structure, Sign and Play in the Discourse of the Human Sciences’. In Writing and Difference. Chicago: University of Chicago Press, 1978. <a class='biblink' href='http://www2.csudh.edu/ccauthen/576f13/DrrdaSSP.pdf'>></a>",
"Eadicicco, Lisa. ‘Your Facebook Data Is Stored Inside This Massive Warehouse’. Time, 28 September 2016. <a class='biblink' href='https://time.com/4508165/facebook-data-center-photos-2016/'>></a>",
"Easterling, Keller. Extrastatecraft: The Power of Infrastructure Space. London ; New York: Verso, 2014.",
"Easterling, Keller. The Action Is the Form: Victor Hugo’s Ted Talk. First edition. Moscow: Strelka Press, 2012.",
...
"Haraway, Donna. ‘A Cyborg Manifesto: Science, Technology, and Socialist-Feminism in the Late 20th Century’. In The International Handbook of Virtual Learning Environments, edited by Joel Weiss, Jason Nolan, Jeremy Hunsinger, and Peter Trifonas, 117–58. Dordrecht: Springer Netherlands, 2006. <a class='biblink' href='https://doi.org/10.1007/978-1-4020-3803-7_4'>></a>",
"Hui, Yuk. ‘For a Planetary Thinking’. e-flux, December 2020. <a class='biblink' href='https://www.e-flux.com/journal/114/366703/for-a-planetary-thinking/'>></a>",
"Judge, Peter. ‘Amsterdam Resumes Data Center Building, after a Year’s Moratorium’. Data Centre Dynamics. Accessed 3 May 2021. <a class='biblink' href='https://www.datacenterdynamics.com/en/news/amsterdam-resumes-data-center-building-after-years-moratorium/'>></a>",
"Kamiya, George. ‘Data Centres and Data Transmission Networks – Analysis’. IEA. Accessed 5 April 2021. <a class='biblink' href='https://www.iea.org/reports/data-centres-and-data-transmission-networks'>></a>",
"Levine, David. ‘Act Natural’. Frieze (blog), 15 December 2017. <a class='biblink' href='https://www.frieze.com/article/act-natural-0'>></a>",
"Mah, Paul. ‘Reducing the Carbon Footprint of Singapore’. Data Centre Dynamics, 26 November 2019. <a class='biblink' href='https://www.datacenterdynamics.com/en/analysis/reducing-carbon-footprint-singapore/'>></a>",
"Office of the Government Chief Information Officer, HKSAR Government. ‘Measures to Facilitate the Development of Data Centres’. Legislative Council Brief, March 2016. <a class='biblink' href='https://www.legco.gov.hk/yr11-12/english/panels/itb/papers/itb-gcio11135c-e.pdf'>></a>",
"Omran, Abdel R. ‘The Epidemiologic Transition: A Theory of the Epidemiology of Population Change: The Epidemiologic Transition’. Milbank Quarterly 83, no. 4 (December 2005): 731–57. <a class='biblink' href='https://doi.org/10.1111/j.1468-0009.2005.00398.x'>></a>",
"Park, Chan-kyong. ‘Naver Confirms Move of Data Centre from Hong Kong to Singapore’. South China Morning Post, 21 July 2020. <a class='biblink' href='https://www.scmp.com/week-asia/politics/article/3094084/national-security-law-naver-moves-data-centre-hong-kong'>></a>",
"Pascual, Rex. ‘Most Expensive Property Market - Hong Kong $1.23 Million Per Property’. StockApps, 22 September 2020. <a class='biblink' href='https://stockapps.com/blog/2020/09/22/most-expensive-property-market-hong-kong-1-23-million-per-property/'>></a>",
"‘Qianhai Data Center’. Accessed 5 April 2021. <a class='biblink' href='https://www.mecanoo.nl/Projects/project/231/Qianhai-Data-Center'>></a>",
"Research Office, Information Services Division. ‘Housing Statistical Highlights’. Legislative Council Secretariat, 22 November 2016. <a class='biblink' href='https://www.legco.gov.hk/research-publications/english/1617issh09-public-housing-20161122-e.pdf'>></a>",
"Steyerl, Hito. ‘In Free Fall: A Thought Experiment on Vertical Perspective - Journal #24 April 2011 - e-Flux’. e-flux, April 2011. <a class='biblink' href='https://www.e-flux.com/journal/24/67860/in-free-fall-a-thought-experiment-on-vertical-perspective/'>></a>",
"Tam CFA, Tzu Wang, and Chris Ko. ‘Hong Kong Data Centres: The Right Supply for Rising Demand’. DBS Asian Insights, October 2016. <a class='biblink' href='https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&ved=2ahUKEwjzqaHr467wAhVvQt8KHWZwAYgQFjADegQICxAD&url=https%3A%2F%2Fwww.dbs.com.sg%2Ftreasures%2Faics%2FpdfController.page%3Fpdfpath%3D%2Fcontent%2Farticle%2Fpdf%2FAIO%2F161020_insights_the_right_supply_for_rising_demand.pdf&usg=AOvVaw3HpTOvMFLGd92Ks3yil0gn'>></a>",
"The Government of the Hong Kong Special Administrative Region. ‘2016 Population By-Census Thematic Report: Persons Living in Subdivided Units' Published’, 18 January 2018. <a class='biblink' href='https://www.info.gov.hk/gia/general/201801/18/P2018011800595.htm'>></a>"
],
		"about" : ['“No Humans in the City, but Weeds” is an artistic research project undertaken between 2019-2021 by architect Joel Austin and artist Kwan Q Li. Taking Hong Kong as a case in point, the duo observes how data is materialised within urban density, and ponders a future convolution of human and post-human urban environments.', 'The project manifests as a series of essays, illustrations and photographs, accompanied by a short film which is on exhibit in the Hong Kong Pavilion at the 2021 Venice Biennale of Architecture. The research has been presented in EPFL’s 2020-21 LATSIS Symposium Open-forum Deep City: Climate Crisis, Democracy and the Digital, while a related speculative essay is set to be published by the Journal AI & Society: Knowledge, Culture and Communication.]'],
		"acknowledgements" : ["Project funders: Hong Kong Design Trust; Councils for the Arts at MIT",
							"Exhibition: Hong Kong Curatorial Team of the 17th Venice Biennale International Architecture",
							"Website design: <a href='https://www.foreignobjects.net'>Foreign Objects</a>",
							"Journal publishing & review: Santinder Gill; Vere van Gool ",
							"Field visit: MIT Information Systems & Technology", "Special thanks to Marisa Yiu, Andrea Volpe, Lydia Brosnahan, Claudia Rugeles-Vaccaro, Manaswi Mishra and Aarón Montoya-Moraga, for your support in facilitating the project’s realisation."],
